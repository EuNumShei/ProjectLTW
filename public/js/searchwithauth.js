const searchModel2 = document.querySelector('#site-search2');

if(searchModel2){
    searchModel2.addEventListener('keydown', function(e) {
      if (e.keyCode === 13) {
  ...
  if (filterButton) {
    filterButton.addEventListener('click', function() {
        ...
        phones.forEach(function(phone) {
            ...
            modelvalues.forEach(function(modelvalue) {
              ...
              for(var key in criteria){
                console.log(key, criteria[key], values[0], values[1]);
                if(key == values[0]){
        ...
        searchModel2.dispatchEvent(event);
